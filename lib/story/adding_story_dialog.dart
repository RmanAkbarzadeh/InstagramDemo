...
class AddingStoryDialog extends StatelessWidget {
  const AddingStoryDialog({Key? key}) : super(key: key);
          ...
          children: [
            ...
            TextButton(
              onPressed: () async {
                ...
                Navigator.of(context).pushNamed(AddingStoryUseresInput.routeName,arguments: {
